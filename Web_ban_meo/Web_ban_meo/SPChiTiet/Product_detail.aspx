...
<body>
  ...
  <asp:DataList ID="DataList1"  DataKeyField="ProID" runat="server" RepeatColumns="1">
    <ItemTemplate>
       ...
       <div class="card">
        ...
        <div class="details col-md-6">
            ...
            <ol><b>Mô tả chi tiết:</b>
             ...
             <h4 class="price">Giá hiện tại: <span><asp:Label ID="Label4" runat="server" Text='<%# Eval("ProPrice") %>'></asp:Label> VND</span></h4>
            <h7>Ngày Đăng: <asp:Label ID="Label5" runat="server" Text='<%# Eval("UpdateDate") %>'></asp:Label> </h7>
                               <div class ="action">
